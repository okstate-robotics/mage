...
class sensor_data(genpy.Message):
  _md5sum = "332eb78f3f1acad4b5dd698366d5ed2d"
...
"""
  __slots__ = ['Pos_n','Pos_e','Pos_d','V_n_ms','V_e_ms','V_d_ms','u','v','w','roll_deg','pitch_deg','yaw_deg','p_body','q_body','r_body','V_airspeed','course','ki_x','ki_y','ki_z']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       Pos_n,Pos_e,Pos_d,V_n_ms,V_e_ms,V_d_ms,u,v,w,roll_deg,pitch_deg,yaw_deg,p_body,q_body,r_body,V_airspeed,course,ki_x,ki_y,ki_z
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_20f.pack(_x.Pos_n, _x.Pos_e, _x.Pos_d, _x.V_n_ms, _x.V_e_ms, _x.V_d_ms, _x.u, _x.v, _x.w, _x.roll_deg, _x.pitch_deg, _x.yaw_deg, _x.p_body, _x.q_body, _x.r_body, _x.V_airspeed, _x.course, _x.ki_x, _x.ki_y, _x.ki_z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.Pos_n, _x.Pos_e, _x.Pos_d, _x.V_n_ms, _x.V_e_ms, _x.V_d_ms, _x.u, _x.v, _x.w, _x.roll_deg, _x.pitch_deg, _x.yaw_deg, _x.p_body, _x.q_body, _x.r_body, _x.V_airspeed, _x.course, _x.ki_x, _x.ki_y, _x.ki_z,) = _struct_20f.unpack(str[start:end])
      return self
