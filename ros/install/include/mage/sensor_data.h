...
struct MD5Sum< ::mage::sensor_data_<ContainerAllocator> >
{
  ...
  {
    return "332eb78f3f1acad4b5dd698366d5ed2d";
  }

  static const char* value(const ::mage::sensor_data_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x332eb78f3f1acad4ULL;
  static const uint64_t static_value2 = 0xb5dd698366d5ed2dULL;
};
