...
var mage_init = func{
	...
	mage.getNode("player/GNC/Navigation/IMU").addChild("GLOBAL_HOME_LAT-deg");
	mage.getNode("player/GNC/Navigation/IMU").addChild("GLOBAL_HOME_LONG-deg");
	mage.getNode("player/GNC/Navigation/IMU").addChild("GLOBAL_HOME_ALT-ft");

	mage.getNode("player/GNC/Navigation/IMU/GLOBAL_HOME_LAT-deg").setValue(0.0);
	mage.getNode("player/GNC/Navigation/IMU/GLOBAL_HOME_LONG-deg").setValue(0.0);
	mage.getNode("player/GNC/Navigation/IMU/GLOBAL_HOME_ALT-ft").setValue(0.0);
	
	mage.getNode("player/GNC/Navigation").addChild("Navdata");
	mage.getNode("player/GNC/Navigation/Navdata").addChild("ki");
	mage.getNode("player/GNC/Navigation/Navdata/ki").addChild("ki_x");
	mage.getNode("player/GNC/Navigation/Navdata/ki").addChild("ki_y");
	mage.getNode("player/GNC/Navigation/Navdata/ki").addChild("ki_z");


	mage.getNode("player/GNC/Navigation/Navdata/ki/ki_x").setValue(0.0);
	mage.getNode("player/GNC/Navigation/Navdata/ki/ki_y").setValue(0.0);
	mage.getNode("player/GNC/Navigation/Navdata/ki/ki_z").setValue(0.0);
