...
var Nav_init = func{
	...
	alpha = props.globals.getNode("/mage/player/GNC/Navigation/IMU/GLOBAL_HOME_LAT-deg").getValue();
	omega = props.globals.getNode("/mage/player/GNC/Navigation/IMU/GLOBAL_HOME_LONG-deg").getValue();
	h = props.globals.getNode("/mage/player/GNC/Navigation/IMU/GLOBAL_HOME_ALT-ft").getValue();	
...
#setlistener("sim/signals/fdm-initialized",Nav_init);
