...
def FGthread(server_no,instance,controller_hostIP,freq_in=100,freq_out=100,vehicle='c172p',lon=-122.35,lat=37.67,alt=2000,iheading=45,ivel=60):
	...
	sock_in = '--generic=socket,in,'+str(freq_in)+','+str(mpin_IP)+','+str(command_port)+',udp,ControlInputMage'
